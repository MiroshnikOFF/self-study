...
class StudyTestCase(APITestCase):
    ...
    def test_section_create(self) -> None:
        ...
        response = self.client.post('/api/v1/sections/', data)
    ...
    def test_section_retrieve(self):
        ...
        response = self.client.get(f'/api/v1/sections/{self.section.pk}/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_section_update(self):
        ...
        response = self.client.put(f'/api/v1/sections/{self.section.pk}/', data)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.json()['name'], data['name'])
    ...
    def test_section_delete(self):
        ...
        response = self.client.delete(f'/api/v1/sections/{self.section.pk}/')
    ...
    def test_lesson_create(self) -> None:
        ...
        response = self.client.post('/api/v1/lessons/', data)
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        self.assertEqual(response.json()['name'], data['name'])
    ...
    def test_lesson_retrieve(self):
        ...
        response = self.client.get(f'/api/v1/lessons/{self.lesson.pk}/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_lesson_update(self):
        ...
        data = {'name': 'New lesson', 'section': self.section.pk}
        response = self.client.put(f'/api/v1/lessons/{self.lesson.pk}/', data)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.json()['name'], data['name'])
        self.assertEqual(response.json()['author'], self.user.pk)
    ...
    def test_lesson_delete(self):
        ...
        response = self.client.delete(f'/api/v1/lessons/{self.lesson.pk}/')
        self.assertEqual(response.status_code, status.HTTP_204_NO_CONTENT)
    ...
    def test_test_create(self) -> None:
        ...
        response = self.client.post('/api/v1/tests/', data)
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        self.assertEqual(response.json()['name'], data['name'])
    ...
    def test_test_retrieve(self):
        ...
        response = self.client.get(f'/api/v1/tests/{self.test.pk}/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_test_update(self):
        ...
        data = {'name': 'New test', 'lesson': self.lesson.pk}
        response = self.client.put(f'/api/v1/tests/{self.test.pk}/', data)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.json()['name'], data['name'])

    def test_test_delete(self):
        """ Тестирование удаления теста """
        response = self.client.delete(f'/api/v1/tests/{self.test.pk}/')
        self.assertEqual(response.status_code, status.HTTP_204_NO_CONTENT)
    ...
    def test_question_retrieve(self):
        ...
        response = self.client.get(f'/api/v1/questions/{self.question.pk}/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_question_update(self):
        ...
        response = self.client.put(f'/api/v1/questions/{self.question.pk}/', data)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.json()['question'], data['question'])

    def test_question_delete(self):
        """ Тестирование удаления вопроса """
        response = self.client.delete(f'/api/v1/questions/{self.question.pk}/')
        self.assertEqual(response.status_code, status.HTTP_204_NO_CONTENT)
    ...
    def test_answer_update(self):
        ...
        response = self.client.put(f'/api/v1/answers/{self.answer.pk}/', data)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.json()['answer'], data['answer'])

    def test_answer_delete(self):
        """ Тестирование удаления варианта ответа """
        response = self.client.delete(f'/api/v1/answers/{self.answer.pk}/')
        self.assertEqual(response.status_code, status.HTTP_204_NO_CONTENT)
